...
BIZ = manifest.get('businessName', 'Reclaim Tax Credit Specialists')
...
<h2>U0001f680 Quick Navigation</h2>
<ul style="list-style:none;padding:0;">{quick_links}</ul>
<h2 id="files">U0001f4c1 Browse All Schema Files</h2>
...
if __name__ == '__main__':
    print('\U0001f680 STARTING build_public_pages.py')
